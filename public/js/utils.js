 ...
 * 
 * @param {string} productId id to be added
 * @returns {*} the product that has been added
 */
...
/**
 * Decreases the amount of the products in the cart
 * 
...
/**
 * Counts how many certain products there are in the cart
 * 
 * @param {string} productId the id of the product 
 ...
 * 
 * @returns {*} array that contains all the products
 */
